# Assembly Dilinde Programlama Öğretisi

Bu öğretici, AMD64/Intel 64 bit programlamayı kapsar. ARM ve RISC-V gibi diğer işlemcilerin komutları(en: *instructions*) esasen farklı, ama kavramlar aynı. Hepsinde komutlar, kayıt tutucular(en: *registers*), yığınlar(en: stacks) ve diğerleri var. Bir tane işlemcinin assembly dilini öğrendikten sonra farklı işlemcilere uyum sağlamak daha kolay oluyor.

Kendimi, yeni bir işlemci için birkaç saatliğine kod yazdığımı ve bir veya iki hafta sonra ise daha kaliteli kod yazdığımı fark ettim. Bu Z80'den 6502'ye, 6502'den 6809'a, 6809'dan 8086'ya, 8086'dan 68000'e diye devam ediyor. Bir işlemcinin teknik dökümanlarına bakabilmek ve buyruk kümesinin gücünü ve esnekliğini değerlendirebilmek ilginç bir şey. 

Bu öğretici, assembly dilini ilk kez öğrenecek olan acemi ve yeniler içindir. Eğer bu konuda yetkinsen, bu öğretici sana çok şey katabilir ya da katmayabilir.

- [Assembly Dilinde Programlama Öğretisi](#assembly-dilinde-programlama-öğretisi)
    - [Giriş](#giriş)
    - [Bitler, Bytelar, Wordler, ve Sayı Tabanları](#bitler-bytelar-wordler-ve-sayı-tabanları)
    - [Aritmetik İşlemler](#aritmetik-işlemler)
    - [Boole Cebri](#boole-cebri)
    - [Bit Kaydırma](#bit-kaydırma)
    - [Bellek](#bellek)
    - [ELF Dosyaları ve Yükleyici](#elf-files-and-the-loader)
    - [İzinler](#permissions-bölümler-ve-ayrıcalıklı-komutlar)
    - [MMU](#mmu)
        - [Sayfalama ve Takaslama](#sayfalama-ve-takaslama)
    - [Diğer Hatalar](#diğer-hatalar)
        - [Segmentasyon Hatası](#segmentasyon-hatası)
        - [Sıfıra bölme](#sıfıra-bölme)
        - [Geçersiz İşlem Kodu](#geçersiz-işlem-kodu)
        - [Genel Koruma](#genel-koruma)
    - [ALU](#alu)s
    - [x64/AMD64 Kayıtcıları](#x64amd64-kayıtcıları)
        - [Genel Amaçlı Kayıtçılar](#genel-amaçlı-kayıtçılar)
        - [Özel Amaçlı Kayıtçılar](#özel-amaçlı-kayıtçılar)
        - [CPU Kontrol Amaçlı Kayıtçılar](#cpu-kontrol-amaçlı-kayıtçılar)
            - [Yığın](#yığın)
            - [Komut İşaretçisi](#komut-işaretçisi)
            - [Bayraklar](#bayraklar)
- [AMD64 Komut Seti](#amd64-komut-seti)
    - [Assembly Kodu](#assembly-kodu)
    - [Adresleme Modları](#adresleme-modları)
        - [Kayıtçı işlenenler](#kayıtçı-işlenenleri)
        - [Doğrudan Bellek İşlenenleri](#doğrudan-bellek-işlenenleri-daha-çok-anında-işlenenler-olarak-bilinir)
            - [Dolaylı işlenenler](#dolaylı-işlenenler)
            - [Dolaylı Yerdeğiştirmeli](#dolaylı-yerdeğiştirmeli)
            - [Dolaylı Yerdeğiştirmeli ve Ölçekli İndeks](#dolaylı-yerdeğiştirmeli-ve-ölçekli-indeks)
- [Yaygın Kullanılan Komutlar](#yaygın-kullanılan-komutlar)
    - [Aritmetik](#aritmetik)
    - [Boole Cebri](#boole-cebri-1)
    - [Dallandırma ve Alt Rutinler](#dallandırma-ve-alt-rutinler)
    - [Bit Manipülasyonu](#bit-manipülasyonu)
    - [Kayıtçı Manipülasyonu, Dönüşümler](#kayıtçı-manipülasyonu-dönüşümler)
    - [Bayrak Manipülasyonu](#bayrak-manipülasyonu)
    - [Yığın Manipülasyonu](#yığın-manipülasyonu)
- [Assembler Kodu, Direktifleri, ve Makroları](#assembler-kodu-direktifleri-ve-makroları)
    - [Assembler Direktifleri](#assembler-direktifleri)
        - [Bölüm Türü](#bölüm-türü)
        - [bits 16, bits 32, and bits 64, use16, use32, use64](#bits-16-bits-32-and-bits-64-use16-use32-use64)
        - [Yorumlar](#yorumlar)
        - [Sabit Değişkenler](#sabit-değişkenler)
        - [Değişkenler ve Stringler](#değişkenler-ve-stringsler)
        - [Assembler Değişkenleri ve Etiketler](#assembler-değişkenleri-ve-etiketler)
        - [Tekrarlama](#tekrarlama)
        - [Makrolar](#makrolar)
        - [Koşullu Assembly](#koşullu-assembly)
        - [Sınırlama](#sınırlama)
        - [Yapılar](#yapılar)
        - [Includes](#includes)
- [Merhaba Dünya](#merhaba-dünya)
    - [MacOS Versiyonu](#macos-versiyonu)
    - [Linux Versiyonu](#linux-versiyonu)
    - [Nasıl Çalışıyor](#nasıl-çalışıyor)
        - [Linux Sistem Çağrıları](#linux-sistem-çağrıları)
        - [MacOS Sistem Çağrıları](#macos-sistem-çağrıları)
...
Eğer bu yazıyı çevirmek isterseniz lütfen bana pull request atın. Burada listeleyeceğim.
